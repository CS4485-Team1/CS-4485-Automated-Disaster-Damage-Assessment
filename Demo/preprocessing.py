...
def get_pairs(image_directory: str, output_crop_directory: str, scene_id: str | None = None):
...
if __name__ == "__main__":
    ...
    test_image_dir = script_dir.parent / "Backend" / "data" / "santa_rosa" / "images"
    output_crop_dir = script_dir / "output" / "building_crops"
